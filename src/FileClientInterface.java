...
public interface FileClientInterface
{
     ...
     *
     */
    public boolean upload(final String sourceFile, final String destFile, final String group, final UserToken token,final int version, final byte[] encrVers,final byte[] initVector);
     ...
     *
     */
    public ArrayList<Object> download(final String sourceFile, final String destFile, final UserToken token); 
