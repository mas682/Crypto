...
import java.util.*;
	...
	public synchronized void addFile(String owner, String group, String path,int version,byte[] encrVers,byte[] initVector)
	{
		ShareFile newFile = new ShareFile(owner, group, path,version,encrVers,initVector);
		list.add(newFile);
	}
