...
public interface GroupClientInterface
{
     ...
     *
     */
    public ArrayList<Object> getToken(final String username, final Key pub, final Key priv, final Key serv, final Key fServKey);
     ...
     *
     */
    public boolean createUser(final String username, final UserToken token, final Key publicKey);
